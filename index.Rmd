...
```
```{python export-image, include=FALSE, eval=!knitr::is_html_output()}
import plotly.express as px
fig = px.scatter(
    px.data.iris(),
    x="sepal_width",
...
```
```{r iris, echo=FALSE, eval=!knitr::is_html_output(), fig.cap="插入图片", dependson='export-image', out.width="75%"}
